...
CREATE TABLE `egreso` (
  ...
  `descripcion_egreso` varchar(100) NOT NULL,
...
INSERT INTO `egreso` VALUES (1,'2017-01-08','pago',100000),(2,'2017-01-01','pagos varios',1500000),(3,'2017-01-04','compra',500000);
