 ...
 */
@Stateless
public class ListadoEstomatologicoFacade extends AbstractFacade<ListadoEstomatologico> {
    ...
    public ListadoEstomatologicoFacade() {
        super(ListadoEstomatologico.class);
    }
